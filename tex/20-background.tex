...
Before any application can be built, one must understand how well humans can generate indexes to understand how accurate computer need to be in order to match them.
